...
const navigateToProfile = useCallback((Aula: String) => {
  navigate('Profile', {Aula} )
}, [navigate])
  ...
  return(
    <Container>
      <Header>
        ...
        {/* <ProfileButton onPress={()=>{navigateToCalendar(routeParams.codigo, dados.Categoria, dados.Name)}}> */}
          <UserAvatar
            source={{
        ...
        renderItem={({ item: dados }) => (
          ...
          >
            <ProviderAvatar
              source={{
                uri:
                  'https://w7.pngwing.com/pngs/64/222/png-transparent-car-transport-cartoon-car-child-vehicle-cartoon-car.png',
              }}
            />

            <ProviderInfo>
              <ProviderName>Categoria: {dados.Categoria}</ProviderName>
              <ProviderMeta>
                <Icon name="book-open" size={14} color="#ff9000" />
                <ProviderMetaText>{dados.Nome}</ProviderMetaText>
              </ProviderMeta>
              <ProviderMeta>
              ...
              <ProviderMeta>
                ...
                <ProviderMetaText>Saldo: {dados.Saldo}</ProviderMetaText>
              </ProviderMeta>
            </ProviderInfo>
          </ProviderContainer>
        )}
